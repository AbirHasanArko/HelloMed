...
class StaffCommentController extends Controller
{
    ...
    public function update(Request $request, ArticleComment $comment)
    {
        ...
        return redirect()->route('staff.comments.index')->with('success', 'Comment updated successfully.');
    }

    public function destroy(ArticleComment $comment)
    {
        $comment->delete();
        return redirect()->route('staff.comments.index')->with('success', 'Comment deleted successfully.');
    }
}
