...
class StaffPatientController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('staff.patients.index')->with('status', 'Patient created successfully.');
    }
    ...
    public function update(Request $request, User $patient): RedirectResponse
    {
        ...
        return redirect()->route('staff.patients.index')->with('status', 'Patient profile updated successfully.');
    }
    ...
    public function destroy(User $patient): RedirectResponse
    {
        ...
        return redirect()->route('staff.patients.index')->with('status', 'Patient deleted successfully.');
    }
}
