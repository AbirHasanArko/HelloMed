                                ...
                                <div class="mega-dropdown-inner">
                                    <div class="mega-dropdown-sections">
                                        ...
                                        <div class="mega-dropdown-section-col">
                                            ...
                                            <a href="{{ route('admin.contact-messages.index') }}" class="mega-dropdown-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Contact Messages</a>
                                            ...
                                            <a href="{{ route('admin.article-categories.index') }}" class="mega-dropdown-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h7"/></svg> Categories</a>
                            ...
                            <div class="mega-dropdown">
                                <div class="mega-dropdown-inner">
                                    <div class="mega-dropdown-sections" style="grid-template-columns: repeat(3,1fr);">
                                        ...
                                        <div class="mega-dropdown-section-col">
                                            <div class="mega-dropdown-section-title">Others</div>
                                            <a href="{{ route('staff.contact-messages.index') }}" class="mega-dropdown-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Contact Messages</a>
                                            ...
                                            <a href="{{ route('staff.article-categories.index') }}" class="mega-dropdown-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h7"/></svg> Categories</a>
            ...
            <div class="mobile-nav-body">
                ...
                <div class="mobile-nav-accordion" id="mAcc-dashboard">
                    ...
                    <div class="mobile-nav-acc-body">
                        ...
                        <a href="{{ route('admin.contact-messages.index') }}" class="mobile-nav-sub-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Contact Messages</a>
                        ...
                        <a href="{{ route('admin.article-categories.index') }}" class="mobile-nav-sub-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h7"/></svg> Categories</a>
                ...
                <div class="mobile-nav-accordion" id="mAcc-dashboard">
                    ...
                    <div class="mobile-nav-acc-body">
                        ...
                        <div class="mobile-nav-sub-label">Others</div>
                        <a href="{{ route('staff.contact-messages.index') }}" class="mobile-nav-sub-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> Contact Messages</a>
                        ...
                        <a href="{{ route('staff.article-categories.index') }}" class="mobile-nav-sub-link"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h16M4 12h16M4 18h7"/></svg> Categories</a>
                ...
                <div class="sf-col">
                    @auth
                        @if(auth()->user()->isAdmin())
                            ...
                            <a href="{{ route('admin.article-categories.index') }}" class="sf-link">Categories</a>
                        ...
                        @elseif(auth()->user()->isStaff())
                            ...
                            <a href="{{ route('staff.article-categories.index') }}" class="sf-link">Categories</a>
